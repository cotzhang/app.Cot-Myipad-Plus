...
function throwErrorRequest(url, body, header, successcallback, timeout, method) {
	$.ajax({
		url: url,
		data: body,
		type: method ? "get" : "post",
...
function autoRetryRequest(url, body, header, successcallback, timewait, timeout, method) {
	simpleRequest(url, body, header, successcallback, (ax, bx, cx) => {
		...
		setTimeout(function() { autoRetryRequest(url, body, header, successcallback, timewait, timeout) }, timewait)
	}, timeout, method)
}
